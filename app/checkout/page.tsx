      ...
      const options = {
        ...
        handler: async function (response: any) {
          ...
          if (verifyData.success) {
            ...
            clearCart();
            router.push('/products'); // Redirect to products or order success page
          } else {
        ...
        prefill: {
          name: 'Rahul Gupta', // You might want to get this from form inputs
              ...
              <div className="glass-card p-6">
                  ...
                  {paymentMethods.map((method) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className={`p-4 rounded-xl border transition-all duration-300 ${selectedPayment === method.id
                          ? 'border-[#f5c542] bg-[#f5c542]/10'
                          : 'border-white/10 bg-white/5 hover:border-[#f5c542]/50'
                          }`}
                      >
                        <div className="flex items-center gap-3">
                          <Icon className={`w-5 h-5 ${selectedPayment === method.id ? 'text-[#f5c542]' : 'text-gray-400'
                            }`} />
                ...
                >
                  <p className="text-gray-300 text-sm text-center">
                    Proceed to pay securely via Razorpay. You can use Credit/Debit Card, UPI, Net Banking, or Wallets tailored for your convenience.
                  </p>
                </motion.div>
